...
{
    [DbContext(typeof(GlobalEventDbContext))]
    partial class GlobalEventDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GlobalEvents.Domain.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GlobalEvents.Domain.Entities.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2025, 6, 30, 23, 39, 56, 103, DateTimeKind.Local).AddTicks(8744),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2025, 9, 30, 23, 39, 56, 127, DateTimeKind.Local).AddTicks(4624),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2025, 4, 30, 23, 39, 56, 127, DateTimeKind.Local).AddTicks(4657),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2025, 4, 30, 23, 39, 56, 127, DateTimeKind.Local).AddTicks(4748),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2025, 10, 30, 23, 39, 56, 127, DateTimeKind.Local).AddTicks(4759),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Date = new DateTime(2025, 8, 30, 23, 39, 56, 127, DateTimeKind.Local).AddTicks(4774),
            ...
            modelBuilder.Entity("GlobalEvents.Domain.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 12, 30, 23, 39, 56, 128, DateTimeKind.Local).AddTicks(923),
                            OrderTotal = 400,
                            TicketsCount = 5,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 12, 30, 23, 39, 56, 128, DateTimeKind.Local).AddTicks(1591),
                            OrderTotal = 135,
                            TicketsCount = 2,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 12, 30, 23, 39, 56, 128, DateTimeKind.Local).AddTicks(1607),
                            OrderTotal = 85,
                            TicketsCount = 1,
                        ...
                        new
                        {
                            ...
                            EventId = new Guid("62787623-4c52-43fe-b0c9-b7044fb5929b"),
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 12, 30, 23, 39, 56, 128, DateTimeKind.Local).AddTicks(1617),
                            OrderTotal = 245,
                            TicketsCount = 3,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 12, 30, 23, 39, 56, 128, DateTimeKind.Local).AddTicks(1628),
                            OrderTotal = 142,
                            TicketsCount = 2,
                        ...
                        new
                        {
                            ...
                            EventId = new Guid("b419a7ca-3321-4f38-be8e-4d7b6a529319"),
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 12, 30, 23, 39, 56, 128, DateTimeKind.Local).AddTicks(1640),
                            OrderTotal = 40,
                            TicketsCount = 1,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 12, 30, 23, 39, 56, 128, DateTimeKind.Local).AddTicks(1650),
                            OrderTotal = 116,
                            TicketsCount = 2,
                            UserId = new Guid("7aeb2c01-fe8e-4b84-a5ba-330bdf950f5c")
                        });
            ...
            modelBuilder.Entity("GlobalEvents.Domain.Entities.Event", b =>
                {
                    b.HasOne("GlobalEvents.Domain.Entities.Category", null)
                        .WithMany("Events")
